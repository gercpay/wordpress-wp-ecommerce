...
=== GercPay Payment Gateway for WP eCommerce ===
Contributors: Mustpay
Tags: merchant, online payment, payment gateway, acquiring, ecommerce, gercpay, payment, commerce, applepay, visa, googlepay
...
Expand the capabilities of your site with the GercPay payment system!

After installing the GercPay payment module, your customers will be able to pay using:
...
== Reasons to choose GercPay ==

Business opportunities with the GercPay service:
...
* One-click payment. Make your customers' future purchases easier. The GercPay system will remember the necessary data of buyers after the first payment and substitute them in the next.
...
GercPay is fully optimized for use on smartphones, tablets, laptops, desktops, TVs. Your customers will be comfortable to make purchases from any device.
...
[See current tariffs on the GercPay website](https://gercpay.com.ua)


== FAQ ==

Some answers you can find here [FAQ](https://gercpay.com.ua)
...
Download GercPay payment acceptance plugin for WP eCommerce from the WordPress add-ons directory. Unpack this plugin into the /wp-content/plugins/ directory. After that activate it in the “Plugins” menu.

= 2. Module activation =

Go to the WordPress control panel, find the GercPay payment module in the “Plugins” menu. Click on the “Activate”.

= 3. Conclusion of an agreement with a bank =

1. Register on [the service portal](https://gercpay.com.ua).
...
2. Go to “GercPay -> Management”. Let the plugin use this payment method: click “Enable”.
3. Enter the data you received from GercPay (can be found in your merchant's technical settings). You need to fill in two fields — Merchant ID and Merchant secret key.
